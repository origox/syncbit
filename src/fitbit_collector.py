...
class FitbitCollector:
    ...
    def _make_request(self, endpoint: str, params: Optional[dict] = None) -> dict:
        ...
        try:
            ...
            if e.response.status_code == 429:
                ...
                raise RateLimitError(f"Rate limited by Fitbit API", retry_after)
    ...
    def get_daily_data(self, date: datetime) -> dict:
        ...
        data = {
            ...
            'distance': activity.get('distances', [{}])[0].get('distance', 0.0) if activity.get('distances') else 0.0,
        ...
        while current_date <= end_date:
            try:
                ...
                if retry_count >= max_retries:
                    ...
                    logger.warning(f"Error fetching {current_date.strftime('%Y-%m-%d')}, "
